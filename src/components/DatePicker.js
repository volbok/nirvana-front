      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
          ...
          <div id="btnAdd"
            ...
            onClick={(e) => {
              if (viewdatepicker == 1) {
                setdatepicker1(datepicker1 + ' - ' + hour + ':' + min);
                setviewdatepicker(0);
              } else {
                setdatepicker2(datepicker2 + ' - ' + hour + ':' + min)
                setviewdatepicker(0);
              }
              e.stopPropagation();
            }}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            >
              {arraylist.map((item) => (
                <button
                  key={'dia ' + item}
                  className={viewdatepicker == 1 && item == datepicker1 ? "button-red" : viewdatepicker == 2 && item == datepicker2 ? "button-red" : "button"}
